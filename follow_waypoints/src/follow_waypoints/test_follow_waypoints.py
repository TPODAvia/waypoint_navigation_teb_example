...
class FollowPath(State):
    def __init__(self):
        ...
        self.final_waypoint_tolerance = rospy.get_param('final_waypoint_tolerance', 0.1)
    ...
    def execute(self, userdata):
        ...
        for i, waypoint in enumerate(waypoints):
            ...
            if not current_tolerance > 0.0:
                ...
                # This is the loop which exits when the robot is near a certain GOAL point.
                distance = 10
...
class PathComplete(State):
    ...
    def execute(self, userdata):
        ...
        return 'success'  # Transition back to FOLLOW_PATH
